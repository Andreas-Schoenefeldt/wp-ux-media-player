...
//			$main .= '</span>';
		...
		public function shortcode_handler( $atts, $content = '', $shortcodename = '', $meta = '' )
		{
			...
			$output .= '<div id="' . $id . '" class="' . implode( ' ', $outer_cls ) . '" ' . $outer_styles . ' data-widgets="sh-ux-media-player" data-download-text="' . Plugin::get_translation('label.download-file') . '" data-item_count="' . count($ids) . '">';
